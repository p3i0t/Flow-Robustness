...
from NormalizingFlows.pixelcnn_layers import down_shifted_conv2d, down_shifted_deconv2d, down_right_shifted_conv2d,\
    down_right_shifted_deconv2d, gated_resnet, nin
from NormalizingFlows.pixelcnn_utils import discretized_mix_logistic_loss, concat_elu
...
if __name__ == '__main__':
    ...
    x_t = Variable(torch.from_numpy(xx_t))
    y_t = Variable(torch.from_numpy(yy_t))
